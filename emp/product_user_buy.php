...
<div class="card" style="width: auto;"><br>
	<h1 class="page-header text-center x">รายการนัดของคุณ</h1>
	<table id="example" class="table table-striped table-bordered">
		<thead>
		    <th><div class="y"><b><b>ลำดับ</div></th>
			<th><div class="y"><b><b>วันเวลา</div></th>
			<th><div class="y"><b><b>ชื่อผู้นัด</div></th>
			<th><div class="y"><b><b>วิชาที่ต้องการติว</div></th>
			<th><div class="y"><b><b>สถานที่</div></th>
			<th><div class="y"><b><b>สถานะ</div></th>
			<th><div class="y"><b><b>รายละเอียด</div></th>
		</thead>
		<tbody>
			<?php
