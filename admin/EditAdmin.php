    ...
    <div class="col-md-12">
        ...
        <div class="form-group ">
              ...
              <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="email" id="username" class="form-control"  value="<?php echo $result['email']?>" name="email" required>
              ...
              <div class="form-group y">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="userlevel">ประเทภสถมาชิก</label>
              ...
              <div class="form-group y">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <select name="status" id="userlevel" class="form-select" required>
                    <option value="<?php echo $result['status'];?>"><?php if($result['status']==1){
                      echo 'เปิดใช้งาน';
                      }else{
                      echo 'ปิดใช้งาน';  
                      }?></option>
