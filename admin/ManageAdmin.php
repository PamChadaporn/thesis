                            ...
                            <div class="content">
                                ...
                                <table id="example"  class="table table-striped">
                                    ...
                                    <?php 
                                            ...
                                            $sql = "SELECT * FROM user Where email != '".$_SESSION['email']."' order by Userlevel DESC";
                                    ...
                                    <thead>
                                    	...
                                    	<th width="15%"><b>ชื่อ-นามสกุล</b></th>
                                        <th width="15%"><b>ประเภท</b></th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <?php if($result['status']==1){?>
                                                    <h3><a href="user_onoff.php?u_id=<?php echo $result['ID'];?>" title="เปิด"><i class="fa-solid fa-toggle-on" style="color: #31e000;"></i></a></h3>
                                                <?php }else{ ?>
                                                    <h3><a href="user_onoff.php?p_id=<?php echo $result['ID'];?>" title="ปิด"><i class="fa-solid fa-toggle-on fa-rotate-180" style="color: #d60000;"></i></a></h3>
                                                <?php } ?>
                                            </td>
                                            <td>  
                                           
                                            <?php if($result['Userlevel'] == 2){?>  
